...
To update the database use this command from the Web project folder (replace `WyomingDotNet` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../WyomingDotNet.Infrastructure/WyomingDotNet.Infrastructure.csproj -s WyomingDotNet.Web.csproj
```
